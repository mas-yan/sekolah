...
<body>
	...
	<div class="col-12">
		<div class="card card-success">
			...
			<div class="card-body">
			<button data-toggle="modal" data-target="#modal-tambah" style="margin-bottom: 20px" type="button" class="btn btn-primary"><i class="fas fa-plus"></i> Tambah Tagihan</button>
		...
		<div class="card card-primary">
			...
			<div class="card-body">
				<table id="example1" class="table table-bordered table-striped">
					...
					<tbody>
						<?php
						$queryTampil = mysqli_query($conn,"SELECT * FROM kelas,siswa,spp WHERE spp.id_kelas = kelas.id_kelas AND siswa.id_kelas = kelas.id_kelas AND kelas.id_kelas = $data") or die(mysqli_error($conn));
						$no = 1;
